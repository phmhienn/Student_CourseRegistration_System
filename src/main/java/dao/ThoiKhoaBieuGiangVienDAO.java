...
public class ThoiKhoaBieuGiangVienDAO {
    public List<ThoiKhoaBieuGiangVien> getByGiangVienHocKy(String maGv, String maHocKy) {
        String sql = """
            SELECT 
              mh.ten_mon,
              lhp.ma_lhp,
        ...
        List<ThoiKhoaBieuGiangVien> list = new ArrayList<>();
        ...
        try (Connection con = DBconn.getConnection();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    ThoiKhoaBieuGiangVien t = new ThoiKhoaBieuGiangVien();
