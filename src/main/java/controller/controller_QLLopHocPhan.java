...
public class controller_QLLopHocPhan {
    ...
    public controller_QLLopHocPhan(view_QuanLyLopHocPhan view, view_Admin adminView) throws Exception {
        this.view = view;
    ...
    private void loadComboMonHoc() throws Exception {
    ...
    private void addEvents() {
        ...
        view.btnThem.addActionListener(e -> {
            try {
                ...
                System.getLogger(controller_QLLopHocPhan.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
            }
        });
    ...
    private void tim() throws Exception {
        model.setRowCount(0);
    ...
    private boolean isTrungLichPhong(String thu, String ca, String phong, String maHocKy, String maLHP) throws Exception {
